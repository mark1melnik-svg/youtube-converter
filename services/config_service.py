...
def load_settings(app):
    ...
    try:
        ...
        app.filename_template = data.get("filename_template", "%(title,id)s")
...
def save_settings(app):
    ...
    data = {
        ...
        "filename_template": app.filename_template,
    ...
    try:
        ...
        app.log(f"⚠️ Failed to save settings: {e}", tag="err")
...
def add_history_entry(app, url: str, mode: str, download_path: str):
    entry = {
        "url": url,
        "mode": mode,
        "path": download_path,
